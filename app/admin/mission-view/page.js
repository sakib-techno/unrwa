...
function MissionVIew() {
    ...
    const classification = async () => {
        try {
            ...
            let classificationData = data.result.map((item, index) => (
                                    ...
                                    <div className='msv-block bg-white shadow-md rounded px-8 pt-6 pb-8 mb-14'>
                                        ...
                                        {vehicles &&
                                            vehicles.map((item, index) => (
                                                <div className='form__info-box' key={index}>
                                                    <h3 className='form__info-box__title'>
                                                        Driver
                                                    </h3>
                                                    <div className='form__row flex-ctr-spb'>
                                            ...
                                            <div className='mdf-form-body'>
                                                <div className='mdf-form-head'>
                                                    ...
                                                    <p>
                                                        ...
                                                        {places.map((item, index) =>
                                                            <span key={index}>{item.departure_umrah_id != null ? item.departure_umrah_id.installation_name : item.departure_installation_name}-{item.arrival_umrah_id != null ? item.arrival_umrah_id.installation_name : item.arrival_installation_name},</span>)}
