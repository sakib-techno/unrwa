    ...
    return (
        <div className="w-full mx-auto">
            <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-14">
                ...
                {locationList && locationList.map((item, index) => <Collapsable1 key={7878} isCollapse={(locationList.length-1) === index} info={item} totalItem={locationList.length} checkValidation={checkValidation} setInfo={handleChange} item={index}/>)}
