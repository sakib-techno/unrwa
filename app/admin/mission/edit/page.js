...
function Steps() {
    ...
    const formElements = [
        <Step1 data={data} key={1} storeData={storeData} checkValidation={checkValidation} classification={classification}
               staffList={staffList} agencyList={agencyList} getdata={handleChange}/>,
        <Step2 data={storeData.location_list} key={2} emptyLocation={dataObject.location_list[0]}
               checkValidation={checkValidation} locationSet={locationStore}/>,
        <Step3 data={storeData.vehicle_list} key={3} vehicleStaff={vehicleStaff} emptyVehicle={dataObject.vehicle_list[0]} checkValidation={checkValidation}
